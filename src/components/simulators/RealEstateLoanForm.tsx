type Props = {
  ...
  tauxAnnuel: string;
  dureeAnnees: string;
  onPrixBienChange: (v: string) => void;
  onApportChange: (v: string) => void;
  onTauxAnnuelChange: (v: string) => void;
  onDureeAnneesChange: (v: string) => void;
};

export default function RealEstateLoanForm({
  prixBien,
  apport,
  tauxAnnuel,
  dureeAnnees,
  ...
  return (
    <div className="bg-zinc-900 rounded-3xl p-8 shadow-lg mt-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div>
          <label className="text-zinc-400">Prix du bien</label>

          <div className="relative mt-2">
            <input
              type="number"
              value={prixBien}
              onChange={(e) => onPrixBienChange(e.target.value)}
        ...
        <div>
          <label className="text-zinc-400">Apport</label>
        ...
        <div>
          <label className="text-zinc-400">Taux du prêt</label>
